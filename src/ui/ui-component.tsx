...
export const UiComponent: React.FC<OwnPropsType> = (
    ...
    return (
        <div className={ styles.component }>
            ...
            <SplitList label={ '-->.<-- сужение' } inputValue={ [ ...numArray, ...reverseArray ] }
                       infoText={ textStringValue }/>
            <SplitList label={ '<--.--> сужение' } inputValue={ [ ...reverseArray, ...numArray ] }
                       infoText={ textStringValue }/>
            <SplitList label={ '-->S<-- сужение' } inputValue={ [ ...numArray, summary, ...reverseArray ] }
                       infoText={ textStringValue }/>
            <SplitList label={ '<--S--> сужение' } inputValue={ [ ...reverseArray, summary, ...numArray ] }
                       infoText={ textStringValue }/>
